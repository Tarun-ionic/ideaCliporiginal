...
export default function AppBar({
    ...
    const toolBar = (
        <View style={[{ flexDirection: 'column' }, signup && { backgroundColor: colors.signupBackground }]}>
            ...
            {profile && (
                <View style={{marginTop:5}}>
                    ...
                    {/* <View
                        ...
                        <Pressable style={{ marginHorizontal: scale.space.s,}} onPress={() => onTrigger(navigate)}>
                            {(subtitle || username) && (
